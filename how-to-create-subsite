...
- Content Scheduler
- ACF UX Collapse
1. **Theme Options** -> Select Theme Mode 2.0 (BEM Views) from the dropdown. Select the Simrishamn color scheme manually by checking the box and typing simrishamn in the field. 
2. **Footer** -> Fill out footer information ﬁelds 
3. Customizer [Automate?] (a) Header -> Widget Settings -> activate • Top Header Left • Top Header Center • Top Header Right • Primary Header Left • Primary Header Center • Primary Header Right (b) Header Widgets -> add [Automate?] i. Top Header Left • Header Widget: Logo 1• Text: Simrishamns Kommun ii. Top Header Center • n/a iii. Top Header Right • Search iv. Primary Header Left [Skip?] • Header Widget: Logo • Header Widget: Menu v. Primary Header Center [Skip?] • Header Widget: Menu vi. Primary Header Right [Skip?] • Header Widget: Links: Search • Header Widget: Links: Mobile Menu (c) Header -> Primary Header -> Select Colors (d) Homepage Settings -> Select Front Page and Posts Archive
